          ...
          <div className="grid md:grid-cols-3 gap-6">
            {([
              ...
              },
              {
                ...
                features: ['Todo en Free', 'do AI — 200 consultas/día', '100 GB de archivos', 'Llamadas grupales', 'Soporte prioritario'],
              ...
              },
              {
                ...
                features: ['Todo en Pro', 'do AI — ilimitado', 'Almacenamiento ilimitado', 'SLA garantizado', 'Soporte 24/7', 'Factura empresarial'],
