...
const en = {
  ...
  landing: {
    ...
    pricingSection: { title: 'Plans for every team', sub: 'Start free. Scale when you need it.', disclaimer: 'Cancel anytime · Secure payment via Stripe · Prices in USD' },
    plans: {
      ...
      pro:      { name: 'Pro',      price: '$12.99', period: 'month',   cta: 'Subscribe to Pro',       badge: 'Most popular',    features: ['DO AI · 80 queries per day', 'Finance, Calendar, Writing agents', '50 web searches/month', '5 GB storage', 'Daily proactive brief'] },
      business: { name: 'Business', price: '$29.99', period: 'month',   cta: 'Subscribe to Business',  badge: 'Maximum power',   features: ['DO AI · 200 queries per day', 'All specialized agents', 'Unlimited web searches', '20 GB storage', 'Priority daily brief'] },
    },
  ...
  app: {
    ...
    chats: {
      ...
      aiSubtitle: 'Your smart assistant', todayPanel: 'What matters today',
    ...
    profile: {
      ...
      manageSub: 'Manage subscription', upgrade: 'Upgrade to Pro — $12.99/mo',
...
const es: typeof en = {
  ...
  landing: {
    ...
    pricingSection: { title: 'Planes para cada equipo', sub: 'Empieza gratis. Escala cuando lo necesites.', disclaimer: 'Cancela en cualquier momento · Pago seguro vía Stripe · Precios en USD' },
    plans: {
      ...
      pro:      { name: 'Pro',      price: '$12.99', period: 'mes',     cta: 'Suscribirse a Pro',          badge: 'Más popular',      features: ['DO AI · 80 consultas por día', 'Agentes Finance, Agenda, Redacción', '50 búsquedas web al mes', '5 GB de almacenamiento', 'Brief proactivo diario'] },
      business: { name: 'Business', price: '$29.99', period: 'mes',     cta: 'Suscribirse a Business',     badge: 'Máximo poder',     features: ['DO AI · 200 consultas por día', 'Todos los agentes especializados', 'Búsquedas web ilimitadas', '20 GB de almacenamiento', 'Brief prioritario diario'] },
    },
  ...
  app: {
    ...
    chats: {
      ...
      aiSubtitle: 'Tu asistente inteligente', todayPanel: 'Lo importante de hoy',
    ...
    profile: {
      ...
      manageSub: 'Administrar suscripción', upgrade: 'Mejorar a Pro — $12.99/mes',
